/**
 * ls-history-signals.js — MIRROR of ui/lib/ls-history-signals.js (keep in sync;
 * same pattern as status-logic.js — the Netlify site deploys only this
 * directory, so browser modules can't be imported directly).
 *
 * Signals derived from the nightly LS snapshot history
