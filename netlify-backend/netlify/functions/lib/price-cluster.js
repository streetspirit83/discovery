/**
 * price-cluster.js — MIRROR of ui/lib/price-cluster.js (keep in sync; same
 * pattern as status-logic.js — the Netlify site deploys only this directory).
 *
 * Confluence zones ("Price Cluster") from all known levels.
 *
